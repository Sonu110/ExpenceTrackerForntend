              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <div onClick={()=>onDelete(t._id)} className=" mt-3
                     mb-3 flex h-8 w-8 items-center justify-center rounded-full bg-red-500/10">
